...
spritescan:
	...
	@r0 = address in NES OAM
	@r1 = Properties of sprite 0 (excluding X coordinate)
	@r2 = Properties of first distinct sprite (excluding X coordinate)
	@r3 = Properties of second distinct sprite (excluding X coordinate)
	@r4 = count of sprites matching sprite 0
	@r5 = count of sprites matching first distinct sprite
	@r6 = count of sprites matching second distinct sprite
	@r7 = loop counter  (check up to 17 sprites), exit when counter expires
	@r8 = properties of active sprite (excluding X coordinate)
...
#if COMPY
byte_reverse_table = 0x02000100
.section .append_data
.global byte_reverse_table_init
.global byte_reverse_table
byte_reverse_table_init:
#else
byte_reverse_table:
#endif
